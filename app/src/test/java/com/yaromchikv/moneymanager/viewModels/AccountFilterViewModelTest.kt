...
import com.yaromchikv.moneymanager.feature.presentation.ui.account_filter.AccountFilterViewModel
...
class AccountFilterViewModelTest {
    ...
    fun eventsTest() = coroutineRule.testDispatcher.runBlockingTest {
        viewModel.events.test {
            ...
            assertEquals(AccountFilterViewModel.Event.SelectAccount(mockAccounts[0]), awaitItem())
